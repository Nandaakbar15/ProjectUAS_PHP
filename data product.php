                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="updatebarang.php?id=<?php echo $data["id"]; ?>"><img src="Edit.png" width="60" height="60"></a>
                                                <a href="deletebarang.php?id=<?php echo $data["id"]; ?>" onclick="return confirm('Yakin?')"><img src="delete.jpg" width="60" height="60"></a>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                                    <?php } else { ?>
